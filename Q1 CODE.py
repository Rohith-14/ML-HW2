...
#print('Decision tree train test accuracy score:',acc_decision_tree)

# Tree visualization
from sklearn import tree
fig = plt.figure(figsize=(10, 10))
tree.plot_tree(dt_model, feature_names=list(X_train.columns),filled=True, class_names=['Not survived', 'Survived'])
plt.show()
...
#print('Random forest train test accuracy score:',acc_random_forest)
...
print('Cross fold scores of decision tree',score)

# decision tree Score
dec_avg_score = round(np.mean(score)*100, 2)
print('Decision tree average classfication accuracy:',dec_avg_score)
...
scoring = 'accuracy'
score = cross_val_score(clf, X_train, Y_train, cv=k_fold, n_jobs=1, scoring=scoring)
print('Cross fold scores of random forest',score)
#rf average score
dec_avg_score = round(np.mean(score)*100, 2)
print('Random forest average classfication accuracy:',dec_avg_score)
